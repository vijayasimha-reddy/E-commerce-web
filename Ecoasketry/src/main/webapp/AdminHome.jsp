...
<body>
    ...
    String searchInput=request.getParameter("product");%>
	...
	<header>
		...
		<div class="admin-links">
			<a href="addProduct.jsp">Add Product</a><br> <a
				href="viewAllProducts.jsp">View All Products</a><br> <a
				href="viewAllOrders.jsp">View All Orders</a><br> <a
				href="viewAllUsers.jsp">View All Users</a><br>
		</div>
		<% } %>
	</header>
	...
	if (subCat != null && !subCat.trim().isEmpty()) {
		session.setAttribute("category", subCat);
	}
	String selectedCategory = (String) session.getAttribute("category");
	...
	<div id="carouselExampleCaptions" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active" data-bs-interval="3000"
				...
				<img src="Images/car3.webp" class="d-block w-100"
					alt="Coupon Available" height="430vh">
			</div>
			<div class="carousel-item" data-bs-interval="3000">
				<img src="Images/car2.webp" class="d-block w-100"
					alt=" Happy Shopping" height="430vh">
			</div>
			<div class="carousel-item" data-bs-interval="3000">
				<img src="Images/car11.webp" class="d-block w-100"
					alt="Upcoming Offers" height="430vh">
			</div>
		</div>
	...
	<main>
		<div class="main-div">
			<div class="category-box">
				<form action="AdminHome.jsp" method="get">
					<div class="category-box sidebar">
						<ul>
							<%List<String> allCategories = pdo.getAllCategories();
          					 for (String cat : allCategories) {
                			List<String> subcats = pdo.getSubcategoriesByCategory(cat); %>
							<li><%= cat %>
								<div class="subcategory-list">
									<% for (String sub : subcats) { %>
									<a href="AdminHome.jsp?category=<%= java.net.URLEncoder.encode(sub, "UTF-8") %>"><%=sub %></a>
									<% } %>
								</div></li>
							<% } %>
						</ul>
			...
			<div class="card-container">
				<div class="container">
					<div class="row">
						<% List<Product> p2=(List<Product>)request.getAttribute("productList"); 
   						if(searchInput!=null){ %>
						<div class="col-12">
							<h4 class="mb-4">
						...
						<div class="col-md-4 d-flex">
							<div class="card p-3 position-relative">
							    ...
							    <img src="img/<%=product.getImg_url() %>" class="card-img-top" alt="<%=product.getP_name()%>"></a>
								<div class="card-body">
									<p class="card-text">
										Product Name:<%=product.getP_name() %></p>
									<h6>
										Description:<%=product.getP_desc() %></h6>
									<h5>
										Price:<%=product.getPrice() %></h5>
									...
									<form action="wishlist" method="post">
										<input type="hidden" name="id" value="<%=product.getP_id()%>">
										<button class="btn save-btn" id="wishlist">
						...
						<div class="col-md-4 d-flex">
							<div class="card p-3 position-relative">
							<a href="product.jsp?id=<%=product.getP_id()%>">
							<img src="img/<%=product.getImg_url() %>" class="card-img-top" alt="Product Image"></a>
						<div class="card-body">
